...
bot.on('message', message => {
    if(message.content[0] === prefix) {
        ...
        bot.channels.get('434708800054886400').send("Commande f/hello utilisée par : " + message.author.username);
        }
        ...
        bot.channels.get('434708800054886400').send("Commande f/help utilisée par : " + message.author.username);
        }             
    }    
});
